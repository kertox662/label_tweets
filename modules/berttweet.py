...
class TweetsTVTDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        df = self.read_csv(self.data_path)
        ...
        self.train_label_counts = train_df[self.label_col].value_counts().reindex(range(self.num_labels), fill_value=0).sort_index().values
