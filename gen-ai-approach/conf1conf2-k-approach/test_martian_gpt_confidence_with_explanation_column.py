...
def classify_tweet_with_confidence(text, model_name, api_key=MARTIAN_API_KEY):
    """
    Classify a single tweet and get confidence scores for classes 1 and 2 with explanation
    """
...
def test_martian_confidence_on_csv(model_name, input_csv, output_csv):
    """
    Test Martian GPT on CSV and output results with confidence scores and explanations
    """
    # Load the input data
    ...
    # Fill in the confidence scores and explanations for valid predictions
...
def main():
    parser = argparse.ArgumentParser(description='Test Martian GPT with confidence scores and explanations')
    ...
    parser.add_argument('--output_csv', type=str, default='martian_confidence_GOLD_TEST_with_explanation_column.csv')
